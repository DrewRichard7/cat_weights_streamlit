...
# st.altair_chart(weights).mark_line().encode(
#     x=alt.X(
#         "date",
#     )
# )
...
# sullivan age
st.write(
    f"Sullivan's age: {sully_age['years']} years, {sully_age['months']} months, {sully_age['weeks']} weeks, {sully_age['days']} days"
)

# haruki age
st.write(
    f"Haruki's age: {ruki_age['years']} years, {ruki_age['months']} months, {ruki_age['weeks']} weeks, {ruki_age['days']} days"
)
